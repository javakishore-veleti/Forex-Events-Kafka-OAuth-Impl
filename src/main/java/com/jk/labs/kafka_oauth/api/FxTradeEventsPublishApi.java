...
import com.jk.labs.kafka_oauth.messaging.producer.FxTradeEventsPublisher;
...
public class FxTradeEventsPublishApi {
    ...
    public ResponseEntity<String> publish(@RequestParam(value = "auth-providers-csv", required = false) String authProvidersCsv,
                                          @RequestParam(value = "no-of-events", required = false, defaultValue = "1") int noOfEvents) {
        fxTradeEventsPublisher.publishFxTradeEvent(noOfEvents, authProvidersCsv);
