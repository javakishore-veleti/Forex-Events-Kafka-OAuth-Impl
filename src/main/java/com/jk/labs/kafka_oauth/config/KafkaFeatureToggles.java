...
public class KafkaFeatureToggles {
    ...
    public static class Consumers {
        private Map<String, ProviderToggle> oauth_provider;
        public Map<String, ProviderToggle> getOauth_provider() { return oauth_provider; }
        public void setOauth_provider(Map<String, ProviderToggle> oauth_provider) { this.oauth_provider = oauth_provider; }
    }
